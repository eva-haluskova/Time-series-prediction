...
for utocik = utociky
    ...
    for okenicko = okna
        ...
        pocMet = 1; % pocita riadky v matici
        ...
        for vyhladenicko = vyhladenicka       
           ...
           for metodka = metody 
                ...
                pocPar = 1; % pocita stlpce v matici
                ...
                for sigma = sigmy
                    ...
                    for paramko = parametricky
                        ...
                        if okno == 512
                            nazov = "C:\Users\eva\OneDrive\Počítač\Bakalárka\Predikcne-tunely-matlab\utoky\Attack_"+num2str(utok)+"_param_0"+num2str(okno)+".mat";
                        else
                            nazov = "C:\Users\eva\OneDrive\Počítač\Bakalárka\Predikcne-tunely-matlab\utoky\Attack_"+num2str(utok)+"_param_"+num2str(okno)+".mat";
                        end
                        ...
                        timeTunel = linspace(zaciatok+dlzkaOkna, zaciatok+vystup-1, vystup - dlzkaOkna);
                        timeVystup = linspace(zaciatok, zaciatok+vystup-1, vystup);
                        uPovodny = data(zaciatok: zaciatok + vystup-1);
                        if metoda == 5
                             timeTunel = linspace(zaciatok+kalibracia +dlzkaOkna, zaciatok+vystup-1, vystup - kalibracia-dlzkaOkna);
                        end
                        ...
                        switch vykreslenie
                            case 1 % tunel
                                ...
                                nazovFiguryPng = ['C:\Users\eva\OneDrive\Počítač\Bakalárka\Predikcne-tunely-matlab\utok_',num2str(utok),'\tunel_',num2str(sigma),'_sigma\',vyhl,'\',num2str(okno),'\',met,'\','tunel_utok_',num2str(utok),'_',num2str(okno),'_',par,'_',met,'','.png'];
                                nazovFiguryFig = ['C:\Users\eva\OneDrive\Počítač\Bakalárka\Predikcne-tunely-matlab\utok_',num2str(utok),'\tunel_',num2str(sigma),'_sigma\',vyhl,'\',num2str(okno),'\',met,'\','tunel_utok_',num2str(utok),'_',num2str(okno),'_',par,'_',met,'','.fig'];
        ...
        % ukladanie do matov
        nazovSuboru = ['C:\Users\eva\OneDrive\Počítač\Bakalárka\Predikcne-tunely-matlab\skripty\matSubory\utok_',num2str(utok),'_falosne_23_sigma_',num2str(okno),'.mat'];
        save(nazovSuboru,"vysledkyFalosne");
        nazovSuboru = ['C:\Users\eva\OneDrive\Počítač\Bakalárka\Predikcne-tunely-matlab\skripty\matSubory\utok_',num2str(utok),'_ts_23_sigma_',num2str(okno),'.mat'];
        save(nazovSuboru,"vysledkyTs");
        nazovSuboru = ['C:\Users\eva\OneDrive\Počítač\Bakalárka\Predikcne-tunely-matlab\skripty\matSubory\utok_',num2str(utok),'_rozpoznanie_23_sigma_',num2str(okno),'.mat'];

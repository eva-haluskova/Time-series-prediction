    ...
    for metodka = metody
        ...
        for paramko = parametricky
            ...
            for vyhladenicko = vyhladenicka
                ...
                switch vykreslenie
                    case 1 % tunel
                        if metoda == 5
                            ...
                            plot(timeVystup(casUtoku-konstO:casRozpoznaniaM+konstM), uPovodny(casUtoku-konstO:casRozpoznaniaM+konstM ),'blue')
                            plot(timeTunel(casUtoku-konstO+dlzkaOkna:casRozpoznaniaM+konstM ), tunel(1,(casUtoku-konstO+dlzkaOkna:casRozpoznaniaM+konstM )),'black')
                            plot(timeTunel(casUtoku-konstO+dlzkaOkna:casRozpoznaniaM+konstM ), tunel(2,(casUtoku-konstO+dlzkaOkna:casRozpoznaniaM+konstM )), 'black');
                        ...
                        nazovFiguryPng = ['utok_',num2str(utok),'\tunel\',vyhl,'\',num2str(okno),'\',met,'\','tunel_utok_',num2str(utok),'_',num2str(okno),'_',par,'_',met,'.png'];
                        nazovFiguryFig = ['utok_',num2str(utok),'\tunel\',vyhl,'\',num2str(okno),'\',met,'\','tunel_utok_',num2str(utok),'_',num2str(okno),'_',par,'_',met,'.fig'];
                ...
                % vypis uspesnosti
                annotation('textbox',[0.00320512820512822 0.631054131054131 0.09375 0.323786324786337],...
